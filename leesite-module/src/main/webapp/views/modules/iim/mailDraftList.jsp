                    ...
                    <div class="col-md-9">
                        <div class="inbox-body">
                            <div class="inbox-header">
                                <h1 class="pull-left">草稿箱 (${mailDraftCount})</h1>
                                <form:form  id="searchForm" modelAttribute="mailCompose" action="${ctx}/iim/mailCompose/?status=0" method="post" class="form-inline pull-right">
                                            ...
                                            <table id="contentTable" class="table table-striped table-bordered table-hover table-checkable">
                                                ...
                                                <c:forEach items="${page.list}" var="mailCompose">
                                                    <tr>
                                                        ...
                                                        <td class="">
                                                            <a href="${ctx}/iim/mailCompose/draftDetail?id=${mailCompose.id}">${mailCompose.receiver.name}</a>
                                                        </td>
                                                        <td class="mail-ontact">
                                                            <a href="${ctx}/iim/mailCompose/draftDetail?id=${mailCompose.id}">${mailCompose.mail.title}</a>
                                                        </td>
                                                        <td class="mail-subject">
                                                            <a href="${ctx}/iim/mailCompose/draftDetail?id=${mailCompose.id}">${mailCompose.mail.overview}</a>
                                                        </td>
