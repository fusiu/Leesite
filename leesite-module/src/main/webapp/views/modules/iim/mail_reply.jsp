                                        ...
                                        <form:form id="inputForm" modelAttribute="mailBox" action="${ctx}/iim/mailCompose/save" method="post" class="form-horizontal">
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 90%;">
                                                        <sys:treeselect id="receiver" name="receiverIds" value="${mailBox.sender.id}" labelName="receiverNames" labelValue="${mailBox.sender.name}" title="用户" url="/sys/office/treeData?type=3" cssClass="form-control required" notAllowSelectParent="true" checked="true"/>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="active" style="width: 10%;">
