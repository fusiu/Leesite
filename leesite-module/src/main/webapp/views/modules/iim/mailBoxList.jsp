    ...
    <div class="page-sidebar-wrapper">
        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                ...
                <t:menu menu="${fns:getTopMenu()}" parentName="在线办公" currentName="站内信"></t:menu>
            </ul>
            <!-- END SIDEBAR MENU -->
        </div>
        <!-- END SIDEBAR -->
                    ...
                    <div class="col-md-9">
                        <div class="inbox-body">
                            <div class="inbox-header">
                                <h1 class="pull-left">收件箱 (总计${mailBoxCount}，未读${noReadCount })</h1>
                                <form:form id="searchForm" modelAttribute="mailBox" action="${ctx}/iim/mailBox/" method="post" class="form-inline pull-right">
                                    <input id="pageNo" name="pageNo" type="hidden" value="${page.pageNo}"/>
                                    <input id="pageSize" name="pageSize" type="hidden" value="${page.pageSize}"/>
                                    <!-- 支持排序 -->
                                    <table:sortColumn id="orderBy" name="orderBy" value="${page.orderBy}" callback="sortOrRefresh();"></table:sortColumn>
                                            ...
                                            <table id="contentTable" class="table table-striped table-bordered table-hover table-checkable">
                                                ...
                                                <c:forEach items="${page.list}" var="mailBox">
                                                    <tr>
                                                        <td>
                                                            <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                                                <input type="checkbox" class="checkboxes i-checks" id="${mailBox.id}" />
                                                                <span></span>
                                                            </label>
                                                        </td>
                                                        <td>
                                                            <a href="${ctx}/iim/mailBox/detail?id=${mailBox.id}">
                                                                ...
                                                                <c:if test="${mailBox.readstatus =='1'}">
                                                                    <i class="fa fa-envelope-o"> 已读 </i>
                                                                </c:if>
                                                            </a>
                                                        </td>
                                                        <td class="">
                                                            <a href="${ctx}/iim/mailBox/detail?id=${mailBox.id}">${(fns:getUserById(mailBox.sender)).name}</a>
                                                        </td>
                                                        <td class="mail-ontact">
                                                            <a href="${ctx}/iim/mailBox/detail?id=${mailBox.id}">${mailBox.mail.title}</a>
                                                        </td>
                                                        <td class="mail-subject">
                                                            <a href="${ctx}/iim/mailBox/detail?id=${mailBox.id}">${mailBox.mail.overview}</a>
                                                        </td>
