                        ...
                        <div class="inbox-body">
                            ...
                            <div class="inbox-content">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h3>
                                            <span>主题： </span>${mailCompose.mail.title }
                                        </h3>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <h5>
                                            <span>发件人：${(fns:getUserById(mailCompose.sender)).name}</span>
                                        </h5>
                                        <h5>
                                            <span>收件人：${(fns:getUserById(mailCompose.receiver)).name}</span>
                                        </h5>
                                        <h5>
                                            <span>发送时间：<fmt:formatDate value="${mailCompose.sendtime}" pattern="yyyy-MM-dd HH:mm:ss"/></span>
                                        </h5>
                                    </div>
                                </div>
